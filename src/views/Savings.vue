                            ...
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    <DynamicForm
                                        ...
                                        :onSubmit="
                                            (values, actions) =>
                                                addNewSaving(values, actions, afterNewSavingAdded)
                                        "
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle class="text-sm font-medium"> Total Savings </CardTitle>
                        <svg
                ...
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle class="text-sm font-medium"> USD </CardTitle>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="none"
